...
This file preserves the original intent prompt verbatim as submitted by the user.
It is used as the reference for intent review (activity 7) across sessions.
